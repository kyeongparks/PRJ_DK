...
namespace PRJ
{
    public abstract class UILayer : MonoBehaviour
    {
        ...
        internal virtual void OnEscapePressed()
        {
        }

        internal virtual void ShowLayer()
        {
            if (first)
            {
                first = false;
